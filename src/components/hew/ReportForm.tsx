      ...
      navigator.geolocation.getCurrentPosition(
        ...
        (error: GeolocationPositionError) => {
          ...
          toast({
            ...
            description:
              "Could not get GPS location. Please select region manually.",
            variant: "destructive",
          });
          setIsFetchingLocation(false);
        }
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "The new case report has been saved locally.",
      });
      // Reset form
      setSymptoms("");
      setSuspectedDisease("");
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Image upload is simulated and not functional.
            </p>
          </div>
