...
import { LogOut, ShieldAlert, UserCog, Home, LogIn } from "lucide-react"; // ShieldAlert can be an app icon
      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            size="icon"
            asChild
            className="hover:bg-primary-foreground hover:text-primary sm:hidden"
          >
            <Link href="/">
